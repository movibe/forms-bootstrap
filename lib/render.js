...
exports.control = function (name, field) {
    ...
    /*Added Section Class Feature*/
    var section_classes = (field.section_classes !== undefined)?' '+field.section_classes.join(' '):'';

    var html = [
        '<div class="' + klass + section_classes + '">',
        (field.section_text !== undefined)?'<legend>'+field.section_text+'</legend>':'',
